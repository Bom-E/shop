...
ALTER TABLE USER_ACCOUNT DROP COLUMN REFRESH_TOKEN;
SELECT * FROM user_account;


-- 241028 추가
CREATE TABLE REFRESH_TOKEN_MANAGE(
	ID BIGINT AUTO_INCREMENT PRIMARY KEY
	, USER_ID VARCHAR(20)
	, REFRESH_TOKEN VARCHAR(512) NOT NULL
	, ISSUED_AT TIMESTAMP DEFAULT CURRENT_TIMESTAMP() -- 생성 시간
	, EXPIRES_AT TIMESTAMP NOT NULL -- 만료 시간
	, FOREIGN KEY (USER_ID) REFERENCES user_account(USER_ID)
);

SELECT * FROM refresh_token_manage;
